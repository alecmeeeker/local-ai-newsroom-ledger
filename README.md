...
A single static HTML file (`index.html`). The page is structured as a working note in six sections:
...
- §5 — Implementation status, with a chart of cumulative lines of code by subsystem
- §6 — Significant feature commits to date
